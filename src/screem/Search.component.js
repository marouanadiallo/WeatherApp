...
const SearchScreen =  ({navigation}) => {
    ...
    const renderItem = ({ item, index }) =>( 
        <PrintResponseSearch result={item} navigation={navigation} />
    );
               ...
               <Layout style={{flexDirection:"row", justifyContent:"space-between", alignItems:"center"}}>
                   ...
                   <Layout style={{flex:1}}>
                    ...
                    <Layout style={{flex:1, flexDirection:"row", justifyContent:"flex-end"}}>
                        <Button appearance='ghost' status='info' accessoryRight={HelpIcon} onPress={()=>{setVisibleModalHelp(true), setActiveChecked(false)}}/>
                    </Layout>
               </Layout>
                <Divider/>
                        ...
                        <Card disabled={true} style={{ maxHeight: Dimensions.get('screen').height/2}}>
                            ...
                            <Layout style={{ flexDirection:"row", justifyContent:"space-between", alignItems:"center"}}>
                                <CheckBox
                                    ...
                                    onChange={() => setActiveChecked(true)}
                                >
                                    N'est plus affiché.
                                </CheckBox>
                                <Button onPress={() => setVisibleModalHelp(false)} appearance='ghost' status='danger'>
                                    Fermer
                                </Button>
                            </Layout>
                        </Card>
